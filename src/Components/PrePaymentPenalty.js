...
class PrePaymentPenalty extends React.Component {
  ...
  render(){
    return(
    <div>
    <Button type="primary" onClick={this.showModal}>Pre-Payment Penalty Calculator</Button>
    <Modal
    ...
    >
      <Row>
        <Row><p>The Pre-Payment Penalty Calculator will estimate the penalty you have to pay if you break/pre-pay your mortgage based on a Minimum Pre-Payment Penalty or yield maintenance.</p></Row>
        <Row><input type="checkbox" />Check for US Banking Systems</Row>
        <Row>
            <Col span="8">
                Valuation Date
                <Input v-model="value" @change="updateValue"></Input>
            </Col>
        </Row>
        <Row><b>Existing Loan Information</b></Row>
        <Row>
            <Col span="16">
                Loan Amount ($)
                <Input></Input>
